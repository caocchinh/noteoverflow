  ...
  return (
    <div className="grid min-h-svh md:grid-cols-2 bg-background">
      ...
      >
        ...
        >
          <div className="after:border-foreground w-full after:w-[50%] relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:z-0 after:flex after:items-center after:border-t-2 flex justify-center mb-4">
            <motion.h1
