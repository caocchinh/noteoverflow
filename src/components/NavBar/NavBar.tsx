...
const NavBar = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-[100000] flex min-w-screen items-center justify-between border-[var(--navbar-border)] border-b bg-[var(--navbar-bg)] px-1 py-3 sm:px-10 lg:px-20">
