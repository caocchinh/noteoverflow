...
function HoverCard({ ...props }: React.ComponentProps<typeof HoverCardPrimitiveRoot>) {
  return <HoverCardPrimitiveRoot data-slot="hover-card" {...props} />;
}

function HoverCardTrigger({ ...props }: React.ComponentProps<typeof HoverCardPrimitiveTrigger>) {
  return <HoverCardPrimitiveTrigger data-slot="hover-card-trigger" {...props} />;
}
