  ...
  return (
    <div className="relative perspective-midrange">
      ...
      <motion.div
        ...
        className="absolute inset-0 h-96 w-lg rounded-2xl bg-transparent p-2"
      >
        <img
          src={src as string}
          alt="aceternity logo"
          loading="lazy"
          className="absolute inset-0 top-5 h-full! w-full! rounded-lg object-contain object-top-left"
        />
      </motion.div>
    </div>
  );
