...
const BookmarkButtonConsumer = () => {
  ...
  const open = useBookmarkContext((state) => state.open);
  ...
  const isBookmarkError = useBookmarkContext((state) => state.isBookmarkError);
  ...
  const handleKeyDown = useCallback(
    ...
    [searchInput, setOpen, setSearchInput]
  );
  return (
    <Command
