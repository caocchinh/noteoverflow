/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: e7e3026cebbfb6c9ca9feafbada1f497)
...
declare namespace Cloudflare {
  interface Env {
    ...
    TURNSTILE_SECRET_KEY_PASSES: string;
    TURNSTILE_SECRET_KEY_FAIL: string;
    TURNSTILE_SECRET_KEY_ERROR: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY_PASSES_VISIBLE: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY_FAILED_VISIBLE: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY_PASSES_INVISIBLE: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY_FAILED_INVISIBLE: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY_FORCE_INTERACTIVE: string;
    ...
    MAIN_DB: D1Database;
    QUESTION_SEMANTIC_SEARCH_VECTORIZE: VectorizeIndex;
    AI: Ai;
    ASSETS: Fetcher;
  }
}
